                                ...
                                <form class="needs-validation" novalidate="" action="{{ route('pengajuan.tambah') }}"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control @error('no_sjp') is-invalid @enderror"
                                                id="no_sjp" name="no_sjp">
                                            @error('va')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="jenis_kelamin"
                                            ...
                                            <option value="Laki-Laki"
                                                {{ old('jenis_kelamin') == 'Laki-Laki' || $pasien->jenis_kelamin == 'Laki-Laki' ? 'selected' : '' }}>
                                                Laki - Laki</option>
                                            <option value="Perempuan"
                                                {{ old('jenis_kelamin') == 'Perempuan' || $pasien->jenis_kelamin == 'Perempuan' ? 'selected' : '' }}>
                                                Perempuan</option>
                                        </select>
                                        @error('jenis_kelamin')
                                            <div class="invalid-feedback">
                                            ...
                                            <select name="kelurahan_id"
                                                ...
                                                @foreach ($kelurahan as $kel)
                                                    <option value="{{ $kel->kelurahan_id }}"
                                                        {{ old('kelurahan_id') == $kel->kelurahan_id || $pasien->kelurahan_id == $kel->kelurahan_id ? 'selected' : '' }}>
                                                        {{ $kel->kelurahan_nama }} |
                                        ...
                                        <div class="input-group">
                                            <select name="hubungan_kk"
                                                ...
                                                <option value="Kepala Keluarga"
                                                    {{ old('hubungan_kk') == 'Kepala Keluarga' || $pasien->hubungan_kk == 'Kepala Keluarga' ? 'selected' : '' }}>
                                                    Kepala Keluarga</option>
                                                <option value="Istri / Suami"
                                                    {{ old('hubungan_kk') == 'Istri / Suami' || $pasien->hubungan_kk == 'Istri / Suami' ? 'selected' : '' }}>
                                                    Istri / Suami</option>
                                                <option value="Anak / Cucu / Menantu"
                                                    {{ old('hubungan_kk') == 'Anak / Cucu / Menantu' || $pasien->hubungan_kk == 'Anak / Cucu / Menantu' ? 'selected' : '' }}>
                                                    Anak / Cucu / Menantu</option>
                                                <option value="Ayah / Ibu / Mertua"
                                                    {{ old('hubungan_kk') == 'Ayah / Ibu / Mertua' || $pasien->hubungan_kk == 'Ayah / Ibu / Mertua' ? 'selected' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="ket_jamkesda"
                                            ...
                                            <option value="kekerasan"
                                                {{ old('ket_jamkesda') == 'kekerasan' || $pasien->ket_jamkesda == 'kekerasan' ? 'selected' : '' }}>
                                                Pasien Kekerasan</option>
                                            <option value="meninggal"
                                                {{ old('ket_jamkesda') == 'meninggal' || $pasien->ket_jamkesda == 'meninggal' ? 'selected' : '' }}>
                                                Pasien Meninggal</option>
                                            <option value="bencana"
                                                {{ old('ket_jamkesda') == 'bencana' || $pasien->ket_jamkesda == 'bencana' ? 'selected' : '' }}>
                                                Pasien Bencana</option>
                                            <option value="pmks"
                                                {{ old('ket_jamkesda') == 'pmks' || $pasien->ket_jamkesda == 'pmks' ? 'selected' : '' }}>
