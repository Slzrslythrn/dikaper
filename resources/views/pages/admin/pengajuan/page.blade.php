                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    @if ($row->status == 'Draft')
                                                        ...
                                                        <a href="#" class="btn btn-success mx-2" onclick="submitPengajuan(event, '{{ route('pengajuan.ajukan', ['id' => $row->pasien_id]) }}')">Ajukan</a>
                                                    @elseif ($row->status == 'Ditolak')
                                                        <form
                                                            action="{{ route('pengajuan.destroy', ['id' => $row->pasien_id]) }}"
                                                            method="POST">
                                                ...
                                                <a href="{{ route('pengajuan.download', ['id' => $row->pasien_id]) }}"
                                                    class="badge badge-warning text-white my-2 py-2" target="_blank">Download Tanda Terima</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
