        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('data-rumahSakit') }}">Rumah Sakit</a></li>
                    <li class="breadcrumb-item active"><a href="{{ route('data-rumahSakit.buat') }}">Tambah
                            Rumah Sakit</a></li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12 order-md-1">
                                <form class="needs-validation" novalidate="" action="{{ route('data-rumahSakit.simpan') }}"
                                    method="post">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="kode_jenis"
                                            ...
                                            id="firstkode_jenis" placeholder="" value="{{ old('kode_jenis') }}">
                                        @error('kode_jenis')
                                            <div class="invalid-feedback" style="width: 100%;">
                                                {{ $message }}
                                            </div>
