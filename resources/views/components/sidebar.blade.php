        ...
        <div class="tab-content" id="menu">
            ...
            <div class="tab-pane fade {{ request()->is('jamkesda*') ? 'show active' : '' }}" id="table">
                <ul class="metismenu tab-nav-menu">
                    ...
                    <li>
                        <a class="ai-icon" href="{{ route('sktm-data') }}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24" />
                            ...
                            <span class="nav-text {{ request()->is('jamkesda/sktm*') ? 'text-primary' : '' }}">Data
                                SKTM</span>
                            {{-- <span class="badge badge-xs badge-light">06</span> --}}
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('verifikasi') }}">
                            ...
                            <span class="nav-text {{ request()->is('jamkesda/verifikasi/*') ? 'text-primary' : '' }}">
                                Verifikasi
                            </span>
                        </a>
                    </li>
            ...
            <div class="tab-pane fade {{ request()->is('baznas*') ? 'show active' : '' }}" id="forms">
                <ul class="metismenu tab-nav-menu">
                    <li class="nav-label">Forms</li>
                    <li><a class="ai-icon" href="{{ route('baznas') }}" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <polygon points="0 0 24 0 24 24 0 24" />
